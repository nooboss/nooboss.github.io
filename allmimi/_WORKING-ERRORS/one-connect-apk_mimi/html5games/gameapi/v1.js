...
window.ga = function() {
	console.log("Google Analytics override");
};
...
fg_api.prototype.adsModule = function() {
	...
	module.prototype.showAd = function(callback, force) {
		...
		switch (M.provider) {
			...
			case 'dfp':
				...
				if (M.adcount > 1 && M.isNthAdvertising(2)) {
					return M.showAlsoLikedApps(function() {
						return M.showIMA(callback, force);
					}, force);
				}
	...
	module.prototype.rewardedAd = function(callback) {
		...
		return M.showAlsoLikedApps(callback, true);
	};
	...
	module.prototype.showAlsoLikedApps = function(callback, force) {
		...
		var backupApps = [{"id":"famobi/wedding-lily","name":"Wedding Lily","thumb180":"https://img.cdn.famobi.com/portal/html5games/images/tmp/180/WeddingLilyTeaser.jpg"},{"id":"famobi/archery-world-tour","name":"Archery World Tour","thumb180":"https://img.cdn.famobi.com/portal/html5games/images/tmp/180/ArcheryWorldTourTeaser.jpg"},{"id":"famobi/chocolate-biscuits","name":"Chocolate Biscuits","thumb180":"https://img.cdn.famobi.com/portal/html5games/images/tmp/180/ChocolateBiscuitsTeaser.jpg"},{"id":"famobi/slacking-school","name":"Slacking School","thumb180":"https://img.cdn.famobi.com/portal/html5games/images/tmp/180/SlackingSchoolTeaser.jpg"},{"id":"famobi/puppy-maker","name":"My Puppy","thumb180":"https://img.cdn.famobi.com/portal/html5games/images/tmp/180/PuppyMakerTeaser.jpg"},{"id":"famobi/fidget-spinner-high-score","name":"Fidget Spinner High Score","thumb180":"https://img.cdn.famobi.com/portal/html5games/images/tmp/180/FidgetSpinner_HighScoreTeaser.jpg"},{"id":"famobi/smarty-bubbles","name":"Smarty Bubbles","thumb180":"https://img.cdn.famobi.com/portal/html5games/images/tmp/180/SmartyBubbles20160620Teaser.jpg"},{"id":"famobi/pizza-realife-cooking","name":"Pizza Realife Cooking","thumb180":"https://img.cdn.famobi.com/portal/html5games/images/tmp/180/PizzaRealifeCookingTeaser.jpg"},{"id":"famobi/color-pixel-art-classic","name":"Color Pixel Art Classic","thumb180":"https://img.cdn.famobi.com/portal/html5games/images/tmp/180/ColorPixelArtClassicTeaser.jpg"},{"id":"famobi/penalty-shooters-2","name":"Penalty Shooters 2","thumb180":"https://img.cdn.famobi.com/portal/html5games/images/tmp/180/PenaltyShooters2Teaser.jpg"},{"id":"famobi/fruita-crush","name":"Fruita Crush","thumb180":"https://img.cdn.famobi.com/portal/html5games/images/tmp/180/FruitaCrushTeaser.jpg"},{"id":"famobi/italian-tiramisu","name":"Italian Tiramisu","thumb180":"https://img.cdn.famobi.com/portal/html5games/images/tmp/180/ItalianTiramisuTeaser.jpg"}];
		...
		function listApps(apps) {
			...
			let ulNode = self.createElement('ul');
			apps.forEach(function(app) {
				let liNode = self.createElement('li');
				let parts = app.id.split('/');
				let gameID = parts[1];
				let aNode = self.createElement('a', {'href': 'javascript:;', 'data-xhref': 'https://play.famobi.com/' + gameID + '/' + self.config.aid + '?original_ref=' + encodeURIComponent(self.getShortLink()), 'title': app.name, 'target': '_blank'});
				let imgHolderNode = self.createElement('div', {'class': 'fg-notify-imgHolder'});
				let imgNode = self.createElement('img', {'src': app.thumb180});
	...
	module.prototype.showIMA = function(callback, force) {
		...
		try {
			...
			M.adsLoader.getSettings().setLocale(self.gametranslation.getNavigatorLanguage());
...
fg_api.prototype.notifyModule = function() {
	...
	module.prototype.setListHeight = function() {
		var $notifyHolder = faZepto(M.element);
		$notifyHolder.removeClass('fixedHeight');

		var $body = faZepto(M.body);
		var bodyHeight = $body.height() + 20;
		var windowHeight = $(window).height();
		
		if (bodyHeight > windowHeight) {
			$notifyHolder.addClass('fixedHeight');
		}
	};
...
fg_api.prototype.highscoresModule = function() {
	...
	module.prototype.submit = function(level, score) {
		...
		if (!self.adapters.has("highscore", "submit")) {
			// Use HTML5Games.com Leaderboards
			if (typeof html5games_api !== "undefined") {
				// Only send total scores, not level scores
				if (level === "TOTAL" && (self.config.aid === "A-MONKEY" || self.config.aid === "A-MONKEY-DEV")) {
					html5games_api.submitScore({"score": score}).then(function() {
						self.showAd();
					});
					return self;
				}
...
fg_api.prototype.sendLiveScore = function(){
	...
	module.prototype.init = function() {
		...
		if (!self.hasFeature("standalone") && window.famobi_env !== "vp") {
			...
			faZepto.getScript(uri, function() {
				if (typeof html5games_api !== "undefined" && (!self.debug || self.config.package_id === 'lovetester')) {
