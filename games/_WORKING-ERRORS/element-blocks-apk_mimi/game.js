    ...
    _createClass(LayoutService, [{
      ...
      value: function getAvailablePowerupsContainerBounds() {
        if (BlockPuzzle.CustomScaleManager.isPortrait()) {
          ...
          var _this$level$windowBou11 = this.level.windowBounds.getBounds(0.8, 1, 0.88, 0.97),
...
(function (BlockPuzzle) {
  ...
  function (_Phaser$Group14) {
    ...
    function AchievementInformer(level) {
      var _this71;

      _classCallCheck(this, AchievementInformer);

      _this71 = _possibleConstructorReturn(this, _getPrototypeOf(AchievementInformer).call(this, level.game));
...
(function (BlockPuzzle) {
  ...
  function (_Phaser$Group17) {
    ...
    function ButtonAchievements(level) {
      ...
      _this75.level = level;
      _this75.button = _this75.add(BlockPuzzle.ButtonUtils.createSimpleButton(BlockPuzzle.Settings.GAME_ATLAS, 'buttonAchievements', 0, 0, 1, _this75.achievementsClicked, _assertThisInitialized(_this75)));
      ...
      _this75.achievementInformer = _this75.add(new BlockPuzzle.AchievementInformer(_this75.level));
    ...
    _createClass(ButtonAchievements, [{
      ...
      key: "achievementsClicked",
      value: function achievementsClicked() {
      ...
      value: function getStarsClicked() {
        ...
        if (BlockPuzzle.Settings.ENABLE_API) {
          if (BlockPuzzle.APIUtils.instance.hasRewardedVideo()) {
            ...
            BlockPuzzle.APIUtils.instance.showRewardedVideo(function () {
