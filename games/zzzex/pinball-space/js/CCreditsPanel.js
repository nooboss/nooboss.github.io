function CCreditsPanel(){
    ...
    this._init = function(){
        ...
        var oTitle = new createjs.Text(""," 40px "+PRIMARY_FONT, PRIMARY_FONT_COLOUR);
        oTitle.y = -80;
        ...
        var oLink = new createjs.Text("www.yiv.com"," 40px "+PRIMARY_FONT, PRIMARY_FONT_COLOUR);
        oLink.y = 100;
    ...
    this._onLogoButRelease = function(){
        CreateLinksInGame('Pinball-Space-Adventure','pregame','logo');
    };
