...
if (typeof window !== "undefined" && !window.famobi) {
        ...
        var famobi = {
                ...
                init: function() {
                    ...
                    return new Promise(function(resolve, reject) {
                        ...
                        let fetch_poly = document.createElement('script');
                        fetch_poly.src = "html5games/gameapi/fetch.umd.js";
                        document.head.appendChild(fetch_poly);
                        ...
                        meta.content = "default-src * 'unsafe-inline' 'unsafe-eval' data: gap: https://ssl.gstatic.com 'unsafe-eval'; style-src 'self' 'unsafe-inline'; media-src *; img-src 'self' data: content:;";
                        document.head.appendChild(meta);

                        let cordova_style = document.createElement('style');
                        cordova_style.innerHTML = `
                          /*
                          cordova recommended css
                          */
                          * {
                          ...
                          document.head.appendChild(cordova_style);
                        //
                ...
                showAd: function(callback) {
                    ...
                    if(window.famobi.config.gameParams.ad_type == "off") {
                        if (typeof callback == "function") {
                            callback();
                        }
                        return;
                ...
                moreGamesLink: function() {
                    ...
                    var url = "https://addictinggames.com";
    ...
    {
      console.log("DEVICE READY - assigning pause und resume events");
      if(!window.famobi)
      {
        console.log("Device ready, but famobi ain't.");
